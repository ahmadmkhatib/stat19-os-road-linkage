...
#
# # notes  STAGE 1 STRUCTURAL IMBALANCE → OUTCOME MODEL — Drive_Car_pct,
...
#
#     STRUCTURAL ZEROS IN TREND VARIABLES — rare-mode trend variables
...
#
# #    BASELINE INJURY LEVEL HETEROGENEITY FLAGS — treated OAs are
